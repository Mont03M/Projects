...
{
    /// <summary>
    /// Represents a Bishop chess piece, inheriting from the ChessPiece class and implementing the IChessMoves interface.
    /// </summary>
    ...
    public class Bishop(IIChessGameService chessGameService, PieceType pieceType, ChessPieceColors pieceColor,
       ChessSquareLocation currentLocation, string pieceImage) : ChessPiece(chessGameService, pieceType, pieceColor, currentLocation, pieceImage), IChessMoves
    {
        #region -- Properties --
        ...
        /// <summary>
        /// Generates valid moves for the Bishop piece on the given chess board, taking into account pin states and allowed pin moves.
        /// </summary>
        ...
        /// <summary>
        /// Generates available moves for the Bishop piece on the given chess board, considering pin states and allowed pin moves.
        /// </summary>
        /// <param name="chessBoard"> the chess board on which to generate moves </param>
        public void GenerateAvailableMoves(Board chessBoard)
        {
            ...
            // If this piece was previously pinned in another context, reset AllowedPinMoves
            if (!this.IsPinned)
            {
                this.AllowedPinMoves = null;
            }

            // get diagonals x and y locations
            var bishopMoves = DiagonalMoves(this.CurrentLocation, chessBoard.ChessSquares_);
            ...
            // Generate peek moves for the Bishop piece on the given chess board
            GeneratePeekMoves(chessBoard.ChessSquares_);
        }

        /// <summary>
        /// Generates attack moves for the Bishop piece on the given chess board, considering available moves and opponent positions.
        /// </summary>
        ...
        /// <summary>
        /// Generates check moves for the Bishop piece on the given chess board, considering the attacker and path to the king.
        /// </summary>
        ...
        /// <summary>
        /// Generates peek moves for the Bishop piece on the given chess board, considering diagonal moves and available peek positions.
        /// </summary>
        ...
        public void GeneratePeekMoves(ObservableCollection<ChessSquare> chessBoard)
        {
            ...
            var peekMoves = DiagonalMoves(this.CurrentLocation, chessBoard, generateAllMoves: true);
        ...
        /// <summary>
        /// Adds a new Peek move to the list of all available moves for the Bishop piece, ensuring thread safety and avoiding null entries.
        /// </summary>
        ...
        /// <summary>
        /// Replaces the entire list of all available moves for the Bishop piece with a new collection, ensuring thread safety and avoiding null entries.
        /// </summary>
        /// <param name="items">The new collection of peek moves.</param>
        public void ReplaceAllAvailableMoves(IEnumerable<Peek>? items)
        {
            lock (SyncRoot.MovesLock) // Ensure thread safety when replacing the list of all available moves
            {
        ...
        /// <summary>
        /// Gets a snapshot of all available moves for the Bishop piece, ensuring thread safety and returning a copy of the list to avoid external modifications.
        /// </summary>
        ...
        /// <summary>
        /// Creates a deep clone of the Bishop piece, including its properties and available moves, ensuring that the clone is independent of the original instance.
        /// </summary>
        /// <returns>A deep clone of the Bishop piece.</returns>
        public Bishop DeepClone_()
        {
            // Create a new Bishop instance with the same properties as the current instance
            var clone = new Bishop(this.ChessGameService, this.PieceType, this.PieceColor,
